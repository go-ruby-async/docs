# go-ruby-async documentation

**Pure-Go, MRI-4.0.5-faithful Ruby async (no cgo)**

`go-ruby-async/async` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `async`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `async`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`async`](https://github.com/go-ruby-async/async) | the library — Ruby's `async` in pure Go |
| [`docs`](https://github.com/go-ruby-async/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-async.github.io`](https://github.com/go-ruby-async/go-ruby-async.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-async/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-async/async](https://github.com/go-ruby-async/async).
